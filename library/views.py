...
#             student = models.StudentExtra.objects.get(enrollment=obj.enrollment)
#             student_email = student.email

#             # Get book details
#             book = models.Book.objects.get(isbn=obj.isbn)
    #         book_title = book.name
    #         deadline = obj.expirydate

    #         # Construct the email
    #         subject = 'Book Issued'
    #         message = f'You have been issued "{book_title}". Please return it by {deadline}.'
